...
## Prerequisites
1. Higress has been installed with support for Istio CRDs enabled. Refer to [Higress installation and deployment documentation](https://higress.cn/docs/latest/ops/deploy-by-helm/m).
