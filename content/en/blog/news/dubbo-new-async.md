...
Dubbo Provides some asynchronous programming capabilities in 2.6.x and earlier versions, including [Asynchronous Call](/zh-cn/docsv2.7/user/examples/async-call/), [Parameter Callback](/zh-cn/docsv2.7/user/examples/callback-parameter/) and [Event Notification](/zh-cn/docsv2.7/user/examples/events-notify/) on Consumer side. There are some brief introductions to the usage and Demo in the above document links.
