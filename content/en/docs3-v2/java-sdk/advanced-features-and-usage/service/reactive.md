...
For Triple usage and configuration, please refer to [Using Triple in IDL](https://dubbo.apache.org/zh/docs3-v2/java-sdk/reference-manual/protocol/triple/idl/), and ensure that the Dubbo version> = 3.1.0.
