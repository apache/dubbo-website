...
Refer to [Configuration Instructions - Configuration Item Manual](/en/overview/mannual/java-sdk/reference-manual/config/properties#config-center) for more configuration items available in the config-center beyond namespace and group.
