...
2. 如果请求源是预期的，请在 `security/serialize.allowlist` 资源文件中声明您所使用的类名，Dubbo 将自动将其加载到安全列表中。请参考 [类检查机制](/en/overview/mannual/java-sdk/advanced-features-and-usage/security/class-check/) 一文。
