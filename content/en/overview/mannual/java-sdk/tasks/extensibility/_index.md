    ...
    <div class="row">
        ...
        <div class="col-sm col-md-6 mb-4">
            <div class="h-100">
                ...
                <p>Through Dubbo's SPI plugin extension mechanism, you can customize SPI extensions to implement custom RPC protocols, filters, routers, and other extension points.</p>
            </div>
        </div>
    </div>
    <hr>
