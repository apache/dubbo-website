...
> For more detailed configuration, refer to [McpBridge Configuration Documentation](https://higress.cn/en/docs/latest/user/mcp-bridge).
...
## Reference Links
* [Use Apache APISIX to Proxy Triple Protocol Traffic](/en/blog/integration/dubbo-triple-with-apisix-gateway.md)
