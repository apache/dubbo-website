...
* 本地或远端 Kubernetes 集群
* 确保 [Prometheus 正确安装](/en/overview/reference/integrations/prometheus/#安装)
...
接下来，执行 Prometheus 查询命令。可以在此确认 [Dubbo 支持的 Metrics 指标](/en/overview/reference/metrics/standard_metrics/)。
