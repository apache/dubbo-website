...
The Zookeeper registry center also supports other control parameters, see the [Registry Configuration Handbook](/en/overview/mannual/java-sdk/reference-manual/config/properties#dubbo.registry)
