...
aliases:
  ...
  - /en/docs3-v2/dubbo-go-pixiu/user/samples/dubbo/dubbo-incomplete
  - /en/overview/reference/pixiu/other/user/samples/dubbo/dubbo-incomplete
...
Although User struct has Time value, generic invoke will return nil. [the simple response](dubbo-query.md#simple-demosimple) time field is disappear.
