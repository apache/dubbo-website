---
aliases:
- /en/docs3-v2/dubbo-go-pixiu/user/samples/dubbo/dubbo-uri
- /en/docs3-v2/dubbo-go-pixiu/user/samples/dubbo/dubbo-uri
- /en/overview/reference/pixiu/other/user/samples/dubbo/dubbo-uri
- /en/overview/mannual/dubbo-go-pixiu/user/samples/dubbo/dubbo-uri
