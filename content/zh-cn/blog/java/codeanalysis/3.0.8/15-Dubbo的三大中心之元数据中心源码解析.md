...
官网参考文章地址:
- [部署架构（注册中心 配置中心 元数据中心](https://dubbo.apache.org/zh-cn/docs/v3.0/concepts/registry-configcenter-metadata/)
- [元数据参考手册](https://dubbo.apache.org/zh-cn/docs/references/metadata/)
...
- 查询所有可用的默认注册中心列表
 ...
 元数据的配置可以参考官网:[元数据参考手册](https://dubbo.apache.org/zh-cn/docs/v3.0/references/metadata/)
