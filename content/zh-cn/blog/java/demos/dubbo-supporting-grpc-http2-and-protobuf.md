...
由于 `protoc-gen-dubbo-java` 支持 gRPC 和 Dubbo 两种协议，可生成的 stub 类型，默认值是 gRPC，关于 dubbo 协议的使用可参见 [使用 Protobuf 开发 Dubbo 服务](/zh-cn/docs3-v2/java-sdk/quick-start/idl/)。
...
配置方式和 Dubbo 提供的通用的 [TLS 支持](/zh-cn/docs3-v2/java-sdk/advanced-features-and-usage/security/tls/)一致，具体请参见文档
