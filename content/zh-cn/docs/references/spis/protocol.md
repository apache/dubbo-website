---
aliases:
    - /zh/docs/references/spis/protocol/
description: 协议扩展
linkTitle: 协议扩展
title: 协议扩展
type: docs
...
{{% pageinfo %}} 此文档已经不再维护。您当前查看的是快照版本。如果想要查看最新版本的文档，请参阅[最新版本](/zh-cn/overview/mannual/java-sdk/reference-manual/spi/description/protocol/)。
{{% /pageinfo %}}
