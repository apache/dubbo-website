...
aliases:
    ...
    - /zh-cn/overview/mannual/golang-sdk/tutorial/deploy2/proxyless_service_mesh/
description: 无代理服务网格
keywords: 无代理服务网格
title: 无代理服务网格
type: docs
...
示例源码：<a href="https://github.com/apache/dubbo-go-samples/tree/main/mesh" target="_blank">dubbo-go-samples/mesh</a>。
...
dubbogo-cli 现在维护在 Apache dubbo-go 主仓库的 `tools/dubbogo-cli` 目录下，为开发者提供应用模板创建、
工具安装、接口调试等能力，以提高研发效率。

详情可以参阅 [【dubbogo-cli 工具】](/zh-cn/overview/mannual/golang-sdk/tools/dubbogo-cli/)
