---
alias:
 - /zh-cn/overview/reference/protocols/http/
description: "Dubbo 中 REST 风格的 HTTP+JSON 通信及编码使用方式"
linkTitle: REST 风格的 HTTP+JSON 通信及编码使用方式
title: REST 风格的 HTTP+JSON 通信及编码使用方式
type: docs
weight: 3
