...
1. 如果仅使用 REST 协议作为服务提供者，可以配置协议为 `tri`，使用方式无需改变，详见 [Triple 3.3新特性](/zh-cn/overview/mannual/java-sdk/reference-manual/protocol/triple-3.3/) 和 [Triple REST 用户手册](/zh-cn/overview/mannual/java-sdk/reference-manual/protocol/tripe-rest-manual/)
