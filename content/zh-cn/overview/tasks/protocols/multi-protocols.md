...
关于Dubbo支持的配置方式，可以参考[配置说明](https://dubbo.apache.org/zh-cn/overview/mannual/java-sdk/reference-manual/config/)
...
完成Qos模块的导入之后，相关的配置项可参考[Qos操作手册](https://dubbo.apache.org/zh-cn/overview/mannual/java-sdk/reference-manual/qos/overview/)进行配置。
