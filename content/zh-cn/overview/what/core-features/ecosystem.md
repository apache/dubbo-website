...
| 可视化观测平台 | `Admin` | [Grafana](/zh-cn/overview/mannual/java-sdk/tasks/observability/grafana/) | [Prometheus](/zh-cn/overview/mannual/java-sdk/tasks/observability/prometheus/) | - | - |
...
| 限流降级 | [Sentinel](/zh-cn/overview/mannual/java-sdk/tasks/rate-limit/sentinel) | `Resilience4j` | `Hystrix` | - | - |
| 分布式事务 | `Seata` | - | - | - | - |
| 网关 | [Higress]({{< relref "../../../../blog/integration/how-to-proxy-dubbo-in-higress" >}}) | `APISIX` | [Shenyu]({{< relref "../../../../blog/integration/how-to-proxy-dubbo-in-apache-shenyu" >}}) | [Envoy](https://www.envoyproxy.io/docs/envoy/latest/configuration/listeners/network_filters/dubbo_proxy_filter) | - |
