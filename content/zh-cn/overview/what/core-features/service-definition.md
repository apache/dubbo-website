...
### 创建项目
<a href="https://start.dubbo.apache.org/bootstrap.html" target="_blank">Dubbo 微服务项目脚手架</a>（支持浏览器页面、命令行和 IDE）可用于快速创建微服务项目，只需要告诉脚手架期望包含的功能或组件，脚手架最终可以帮助开发者生成具有必要依赖的微服务工程。更多脚手架使用方式的讲解，请参见任务模块的 [通过模板生成项目脚手架](/zh-cn/overview/tasks/develop/template)
...
* [Java 微服务开发入门](../../mannual/java-sdk/quick-start)
* [Go 微服务开发入门](../../mannual/golang-sdk/quickstart)
* [Rust 微服务开发入门](../../mannual/rust-sdk/quick-start)
