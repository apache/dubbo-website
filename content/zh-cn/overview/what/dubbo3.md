...
* **小白用户，快速浏览 Dubbo3 核心特性：**
  * [下一代通信协议 - Triple](/zh-cn/docs3-v2/java-sdk/concepts-and-architecture/triple/)
  * [百万实例集群的秘密 - 应用级服务发现](/zh-cn/docs3-v2/java-sdk/concepts-and-architecture/service-discovery/)
  * [Dubbo Mesh](/zh-cn/docs3-v2/java-sdk/concepts-and-architecture/mesh/)
* **Dubbo3 的兼容性与迁移成本?**
  * [Java - 迁移指南](/zh-cn/docs3-v2/java-sdk/upgrades-and-compatibility)
  * [Golang - 迁移指南](/zh-cn/docs3-v2/golang-sdk/)
* **Dubbo3 相关资源：**
  * 更多资料，如性能指标、高级特性说明等请参考 [多语言 SDK 实现](/zh-cn/overview/mannual/)
  * 演讲与线下活动
...
### 面向百万集群实例，横向可扩容
随着微服务实践经验的积累，微服务被拆分成更细粒度，部署到越来越多的机器实例，以支撑不断增长的业务规模。在众多的 Dubbo2 企业用户中，尤其是以金融保险、互联网为代表的规模化企业开始遇到集群容量瓶颈问题（典型的请参照 [工商银行实践案例](/zh-cn/users/icbc/) ）：
* **服务发现过程**
    * 注册中心数据存储规模达到容量瓶颈
    * 数据注册&推送效率严重下降
* **Dubbo 进程**
