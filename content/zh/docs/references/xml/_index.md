...
这里以 XML Config [^1] 为准，列举所有配置项 [^2]。其它配置方式，请参见相应转换关系：[属性配置](/zh/docs/references/configuration/properties)，[注解配置](/zh/docs/references/configuration/annotation)，[API 配置](/zh/docs/references/configuration/api)。
