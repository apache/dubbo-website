...
Java SDK 支持 [IDL 生成 Stub](../../java-sdk/reference-manual/protocol/triple/idl.md)
和 [Java Interface](../../java-sdk/reference-manual/protocol/triple/idl.md) 两种方式，多语言、生态互通、流式需求推荐使用 IDL 方式，现有服务平滑升级推荐使用
Interface 方式。

- 已有服务参考[从现有协议升级至 Triple](TBD)
- 新服务参考[Dubbo3 Triple Quick Start](../../java-sdk/quick-start/_index.md)
