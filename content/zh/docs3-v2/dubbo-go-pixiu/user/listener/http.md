...
- HTTP to Dubbo 请求的转换，[案例](/zh/docs3-v2/dubbo-go-pixiu/user/samples/http_to_dubbo/)
- HTTP 请求代理，[案例](/zh/docs3-v2/dubbo-go-pixiu/user/samples/http_proxy/)
...
具体案例可以查看 [案例](/zh/docs3-v2/dubbo-go-pixiu/user/samples/https/)
