...
* [如何从接口级服务发现迁移到应用级服务发现](https://dubbo.apache.org/zh/docs3-v2/java-sdk/upgrades-and-compatibility/2.x-to-3.x-compatibility-guide/)
* [饿了么应用级服务发现实践](https://dubbo.apache.org/zh/users/eleme/)
* [工商银行应用级服务发现实践](https://dubbo.apache.org/zh/users/icbc/)
