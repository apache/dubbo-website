...
* [6 示例](./demos/index.md)
    ...
    * [6.22 异步调用](./demos/async-execute-on-provider.md)
    * [6.23 本地调用](./demos/local-call.md)
    * [6.24 参数回调](./demos/callback-parameter.md)
    * [6.25 事件通知](./demos/events-notify.md)
    * [6.26 本地存根](./demos/local-stub.md)
    * [6.27 本地伪装](./demos/local-mock.md)
    * [6.28 延迟暴露](./demos/delay-publish.md)
    * [6.29 并发控制](./demos/concurrency-control.md)
    * [6.30 连接控制](./demos/config-connections.md)
    * [6.31 延迟连接](./demos/lazy-connect.md)
    * [6.32 粘滞连接](./demos/stickiness.md)
    * [6.33 令牌验证](./demos/token-authorization.md)
    * [6.34 路由规则](./demos/routing-rule.md)
    * [6.35 配置规则](./demos/config-rule.md)
    * [6.36 服务降级](./demos/service-downgrade.md)
    * [6.37 优雅停机](./demos/graceful-shutdown.md)
    * [6.38 主机绑定](./demos/hostname-binding.md)
    * [6.39 日志适配](./demos/logger-strategy.md)
    * [6.40 访问日志](./demos/accesslog.md)
    * [6.41 服务容器](./demos/service-container.md)
    * [6.42 Reference Config 缓存](./demos/reference-config-cache.md)
    * [6.43 分布式事务](./demos/distributed-transaction.md)
