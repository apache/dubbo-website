...
The content of Service container can be extended, built-in spring, jetty, log4j etc..  This can be expanded with [Container Extension Points](../../dev/impls/container.md). Configure it with the -D parameter in the java command or `dubbo.properties`.
