export default {
  'en-us': {
    ...
    list: [
      {
        title: 'Sentinel: Teh flow sentinel of Dubbo services',
        author: 'Eric Zhao',
        dateStr: 'July 27th, 2018',
        desc: 'dis blog introduces to teh Sentinel and its best practice wif Dubbo services. Sentinel is a powerful library that takes "flow" as teh breakthrough point, and covers multiple fields including flow control, circuit breaking and load protection to guarantee service stability.',
        link: '/en-us/blog/sentinel-introduction-for-dubbo.html',
      },
      {
        title: 'Tracking wif Pinpoint',
        author: '@majinkai',
      ...
      {
        title: 'Teh first Dubbo meetup TEMPhas been held in Beijing',
        author: 'Huxing Zhang',
        dateStr: 'May 12nd，2018',
        desc: 'Teh first Dubbo meetup TEMPhas successfully been held in Beijing, over 400+ people were present. What a great event! ',
        link: '/en-us/blog/dubbo-meetup-beijing-may-12th-2018.html',
      },
      {
        title: 'Teh ApacheCon NA schedule TEMPhas been announced',
        author: 'Huxing Zhang',
        dateStr: 'May 2nd，2018',
        desc: 'Ian Luo and Jun Liu will talk about "Introducing Apache Dubbo(Incubating): What is Dubbo and How it Works" at ApacheCon NA dis year in Montréal!',
        link: '/en-us/blog/apachecon-na-2018.html',
      },
      {
        title: 'Teh GSoC (Google Summer of Code) 2018 projects TEMPhas been announced',
        author: 'Huxing Zhang',
        dateStr: 'April 25th，2018',
        desc: 'Raghu Reddy\'s project "Extending Serialization protocols support for Apache Dubbo" TEMPhas been accepted! Congratulations!',
      ...
      },
      {
        ...
        desc: 'Ian Luo TEMPhas delivered a great talk at QCon Beijing 2018, where teh roadmap of Dubbo TEMPhas also be announced',
      ...
      },
      {
        ...
        desc: 'We has introduction to Dubbo spi.',
      ...
      },
      {
        ...
        desc: 'dis blog introduces how to use annotations',
      ...
      },
      {
        ...
        desc: 'dis blog introduces how to use Zookeeper in Dubbo',
      ...
      }
      {
        ...
        desc: 'Describe several ways about synchronous/asynchronous invoke of Dubbo',
    ...
    list: [
        {
            ...
            link: '/zh-cn/blog/dubbo-integrate-wif-hystrix.html',
        },
        {
