...
export default {
  'zh-cn': {
    ...
    users: {
      title: '谁在使用Dubbo',
      desc: <span>请在 <a target="__blank" href="https://github.com/apache/incubator-dubbo/issues/1012">Wanted: who&#39;s using dubbo</a> 上提供信息来帮助Dubbo做的更好。</span>,
      list: [
  ...
  'en-us': {
    ...
    users: {
      ...
      desc: <span>Providing your info on <a target="__blank" href="https://github.com/apache/incubator-dubbo/issues/1012">Wanted: who&#39;s using dubbo</a> to help improving dubbo better</span>,
      list: [
        './img/users_alibaba.png',
        './img/users_kingdee.png',
        './img/users_dangdang.png',
